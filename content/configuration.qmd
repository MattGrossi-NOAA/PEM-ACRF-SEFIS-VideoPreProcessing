...
`include_audio`             | (Boolean) If true, audio is included in the output video. Defaults to False.
`log_file`                  | (str) Path to and name of the log file where processing information will be recorded. Defaults to `./processing.log` (in the present working directory).
