...
- Audio can optionally be included in the output video by setting `include_audio: True` in the configuration file. It is omitted by default to minimize file size as much as possible.
